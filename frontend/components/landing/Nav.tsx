  ...
  return (
    ...
    >
      <nav className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6">
        <Link href="/" className="flex items-center gap-2.5 text-sm tracking-tight">
        ...
        <div className="hidden items-center gap-8 text-sm text-muted md:flex">
          <a href="#loop" className="transition-colors hover:text-fg">How it works</a>
          <a href="#models" className="transition-colors hover:text-fg">Models</a>
          <a href="#keys" className="transition-colors hover:text-fg">Your keys</a>
        </div>

        <div className="flex items-center gap-3">
          {signedIn ? (
            <>
              <Link href="/studio" className="text-sm text-muted transition-colors hover:text-fg">
                Studio
              </Link>
              <a
                href="/auth/logout"
