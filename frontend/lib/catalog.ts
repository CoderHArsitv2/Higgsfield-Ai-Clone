...
const FALLBACK: PublicModel[] = [
  ...
  m(
    ...
    "Sandbox",
    "video",
    "Text-to-video with camera motion. No key needed.",
    true,
    true,
  ),
  m(
    ...
    "Sandbox",
    "audio",
    "Text to speech for voiceover drafts.",
    true,
  ),
  m(
    "Kling 3.0",
    "fal.ai",
    "video",
    "Photorealism with complex motion.",
    false,
    true,
  ),
  m(
    ...
    "fal.ai",
    "video",
    "Native audio-video with synced lip-sync in one pass.",
    false,
    true,
  ),
  m(
    ...
    "Google AI",
    "video",
    "4K cinematic generation with native synced audio.",
    false,
    true,
  ),
  m(
    ...
    "OpenAI",
    "video",
    "World simulation with accurate physics.",
    false,
  ),
  m(
    "Wan 2.7",
    "fal.ai",
    "video",
    "The speed and richness balance point.",
    false,
  ),
  ...
  m(
    ...
    "fal.ai",
    "video",
    "Strong prompt adherence on stylised motion.",
    false,
  ),
  m(
    "Ray 3",
    "fal.ai",
    "video",
    "Fluid natural motion with scene coherence.",
    false,
  ),
  m(
    "Hunyuan Video",
    "Replicate",
    "video",
    "Open-weights video model with strong motion.",
    false,
  ),
  m(
    "LTX Video",
    "Replicate",
    "video",
    "Real-time class video generation.",
    false,
  ),
  m(
    "Nano Banana Pro",
    "Google AI",
    "image",
    "Exceptional targeted edits that leave the frame alone.",
    false,
    true,
  ),
  m(
    ...
    "OpenAI",
    "image",
    "Best-in-class instruction following for edits.",
    false,
    true,
  ),
  m(
    ...
    "fal.ai",
    "image",
    "High fidelity stills up to 4MP.",
    false,
  ),
  m(
    "FLUX schnell",
    "Replicate",
    "image",
    "Four-step model for near-instant drafts.",
    false,
  ),
  m(
    "Recraft V3",
    "fal.ai",
    "image",
    "Vector-aware generation with reliable in-image text.",
    false,
  ),
  ...
  m(
    ...
    "Replicate",
    "image",
    "Stable Diffusion XL with a large LoRA ecosystem.",
    false,
  ),
  m(
    ...
    "ElevenLabs",
    "audio",
    "Highest quality speech across 29 languages.",
    false,
    true,
  ),
  m(
    ...
    "ElevenLabs",
    "audio",
    "Low latency speech for long scripts.",
    false,
  ),
  m(
    "MusicGen",
    "Replicate",
    "audio",
    "Text to music for background beds.",
    false,
  ),
];
